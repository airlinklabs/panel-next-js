    ...
    variants: {
      variant: {
        ...
        destructiveSecondary:
          "bg-transparent text-neutral-500 shadow-sm hover:text-red-500/80 hover:bg-red-500/5",
        outline:
          "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-white/5 border border-neutral-300/5 text-secondary-foreground shadow-sm hover:bg-secondary/80",
